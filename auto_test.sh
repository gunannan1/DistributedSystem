...
#登陆client
nohup java -jar target/Client-jar-with-dependencies.jar -l -u u_a -rp 8001 -rh localhost -s s_a > log/client1.log 2>&1 &
nohup java -jar target/Client-jar-with-dependencies.jar -l -u u_b -rp 8001 -rh localhost -s s_b > log/client2.log 2>&1 &
nohup java -jar target/Client-jar-with-dependencies.jar -l -u u_c -rp 8001 -rh localhost -s s_c > log/client3.log 2>&1 &
nohup java -jar target/Client-jar-with-dependencies.jar -l -u u_d -rp 8004 -rh localhost -s s_d > log/client4.log 2>&1 &